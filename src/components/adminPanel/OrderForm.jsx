// app/admin/components/OrderForm.jsx
"use client";
import { useState } from "react";

export default function OrderForm({ onSubmit, initialData = {} }) {
  ...
  return (
    ...
    >
      <div className="mb-4">
        <label className="block mb-1 font-medium">نام سفارش:</label>
        <input
          type="text"
          value={name}
